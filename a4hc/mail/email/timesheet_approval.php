<?
		$message = '<html>
					...
					<td class="container" bgcolor="#FFFFFF">
						...
						<div class="content">
							<table>
								...
								<tr>
									<td>
										<strong>Hi '.$employee_fullname.',</strong>
                                        
										<p>Your timesheet submission has been '.$purpose_text.'.</p>
			...
			$month = monthtoword($employee_timesheet_month);
			...
			$mail->Subject = "Timesheet Submission Updated for: $month $employee_timesheet_year";
			$mail->Body = $message;
