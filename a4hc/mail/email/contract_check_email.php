					...
					<td class="container" bgcolor="#FFFFFF">
						...
						<div class="content">
							<table>
								...
								<tr>
									<td>
										<strong> Notice for A4HC Admin on contractor '.$username_full.',</strong>
                                        
										<p><br>It has come to our attention that the user '.$username_full.' will have an upcoming expiry date of: '.$expiry_date.'. Just a friendly reminder so that you can take actions accordingly.<br> <br> </p>
