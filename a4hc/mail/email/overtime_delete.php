...
$message = '<html>
					...
					<table>
						...
						<tr>
							<td>
								...
								<p>'.$user_name.' has deleted overtime request <b>'.$overtime_generated_id.'</b> and no longer require your action.</p>
	...
	$mail->Subject = 'Overtime Request Deletion Notice: '.$overtime_generated_id;
	$mail->Body = $message;
