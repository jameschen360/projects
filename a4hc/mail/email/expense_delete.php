...
$message = '<html>
					...
					<table>
						...
						<tr>
							<td>
								...
								<p>'.$user_name.' has deleted Expense claim <b>'.$expense_generated_id.'</b> and no longer require your action.</p>
	...
	$mail->Subject = 'Expense Claim Action Deletion Notice: '.$expense_generated_id;
	$mail->Body = $message;
