<?
							...
							<table>
								...
								<tr>
									<td>
										...
										<p>Welcome to A4HC. An account has been successfully created for you. <br> <br> Your username is <b>'.$username.'</b> <br> Your password is: <b>'.$password.'</b></p>
										<p>To login to your account, please click on the button below.</p>
										<table class="btn-primary" cellpadding="0" cellspacing="0" border="0">
											<tr>
												<td>
													<a href="http://projectz.healthsupplementsplus.com/">A4HC Homepage</a>
												</td>
											</tr>
										</table>
                                        <p>Or use the URL below.</p>
                                        <a href="http://projectz.healthsupplementsplus.com/">http://projectz.healthsupplementsplus.com/</a>
		...
		$mail->Subject = 'Welcome to A4HC '.$username_full;
		$mail->Body = $message;
