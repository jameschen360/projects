...
if(empty($_SESSION['login_user'])) {
	if ($url_vacation_id == "") {
		...
		echo "<meta http-equiv=\"refresh\" content=\"0; url=./login?path=myvacation&hash=vacation_request_view_&id=$url_vacation_id\">";		
	}
...
<div class="splash"> <div class="color-line"></div><div class="splash-title"><h1>A4HC Employee Time Off Request</h1><p>Loading...</p><div class="spinner"> <div class="rect1"></div> <div class="rect2"></div> <div class="rect3"></div> <div class="rect4"></div> <div class="rect5"></div> </div> </div> </div>
<!--[if lt IE 7]>
    ...
    <div class="normalheader transition animated fadeIn small-header">
        <div class="hpanel">
            <div class="panel-body">
                ...
                <small>You can make a time off request here!</small>
				<div class="panel-header"></br>
				</div>
				<div class="panel-header">
				<button type="button" class="btn btn-success" data-remodal-target="vacation_request">
				Make a Request
				</button>
				</div>
            </div>
...
$query_vacation_result = mysqli_query($db, "SELECT * FROM vacation_request WHERE requested_user='$user'");
...
<div id="vacation_request_result" class="content animate-panel">
    <div class="row">
        <div class="col-lg-12">
            <div class="hpanel">
            ...
            <div class="tab-content">
                ...
                <tbody>
				<?
				$query_vacation_result = mysqli_query($db, "SELECT * FROM vacation_request WHERE requested_user='$user' AND application_status='Submitted'");
									...
									<div class="remodal" data-remodal-id="<?echo $modal_detail_id;?>" data-remodal-options="hashTracking: true, closeOnOutsideClick: false">
										...
										<!--	<div class="row">
											...
											<div class="row">
												<div class="col-lg-12">
													<div class="form-group">
														<strong><span class="pull-left" for="vacation_pdf">Manager's Comments:</span></strong><br/><hr/>
														<?
														if ($comment!="") {?>
										...
										<div class="modal-footer">
											...
											<div class="pull-left">
												<button type="button" class="btn btn-danger button_delete" id="delete_<?echo $vacation_request_id?>">Delete</button>
											</div>										
										</div>
									</div><!-- tab-content -->
								</div> <!-- /form --> 								
				...
				$query_vacation_result = mysqli_query($db, "SELECT * FROM vacation_request WHERE requested_user='$user' AND application_status='Approved'");
					while($vacation_array = mysqli_fetch_assoc($query_vacation_result)) {
						$date_from = $vacation_array['date_from'];
						$date_to = $vacation_array['date_to'];
						$status = $vacation_array['application_status'];
				...
				$query_vacation_result = mysqli_query($db, "SELECT * FROM vacation_request WHERE requested_user='$user' AND application_status='Rejected'");
					while($vacation_array = mysqli_fetch_assoc($query_vacation_result)) {
						$date_from = $vacation_array['date_from'];
						$date_to = $vacation_array['date_to'];
						$status = $vacation_array['application_status'];
...
<!-- make request modal -->
	<div id="vacation_remodal" class="remodal-bg">
		<div class="remodal" data-remodal-id="vacation_request" data-remodal-options="hashTracking: false, closeOnOutsideClick: false">
				...
				<div class="modal-header">
					<h4 class="modal-title">Make a Time Off Request</h4>
				</div>
					...
					<!--<div class="input-daterange row form-group" id="datepicker" >
						...
						<div class="row pull-right">
							<div class="col-lg-12">
								<div class="form-group">
									<small><span><strong>Notes:</strong> (please indicate the type of the time off: annual vacation/sick leave/lieu time/others)</span><br/></small>
								</div>
							</div>
						</div>
