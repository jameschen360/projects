	...
	$('#coupon').bind('input propertychange', function() {
        ...
        $.ajax({
          ...
          success: function(msg){
				...
				if (msg === "invalid") {
					var msg_str = $('#output').html("Invalid Coupon Code!");
					...
					var msg_str = $('#output').html('Coupon Applied!'+' '+discount_percentage+'OFF');
					...
					$('#msg_coupon').fadeIn(4000).text("Please refresh the page to enable the \"remove\" button!");
