    ...
    $(document).ready(function () {
      $(".del_button").click(function(){
		...
		string = 'My Cart (' + number + ')';
		string2 = 'Shopping Cart: ' + number + ' Items';	
        ...
        $.ajax({
          ...
          success: function(msg){
            if (msg === 'remove') {
              ...
              $("table.table").hide();
			  $('a#change_num').fadeIn(4000).text('My Cart (0)');
			  $("div#cart_msg").css({"padding-bottom":"13cm"});
			  $('#shopping_num').fadeIn(4000).text('Shopping Cart: 0 Items');
			  $('#cart_msg').fadeIn(4000).text('Your shopping cart is empty!');
