						...
						<div class="col-md-12">
							...
							<div class="tab-content clear-style">
								<div class="tab-pane active" id="pill-1">
									...
									<?
										$related_product = mysqli_query($db, "SELECT * FROM product WHERE legacy <> 'yes' ORDER BY RAND() LIMIT 8");
										...
										while($related_result = mysqli_fetch_assoc($related_product)) {
											...
											$product_desc = $related_result['detail'];
												...
												<div class="listing-item white-bg bordered mb-20">
													<div class="overlay-container">
														...
														if($related_discount != "" or $related_discount != 0){?>
															<span class="badge"><?echo $related_discount*100?>% OFF</span>
														<?}
														?>
														
														<div class="overlay-to-top links">
															<span class="small">
																<a href="product-detail.php?catagory=<?echo $related_catagory?>&id=<?echo $related_id;?>" class="btn-sm-link"><i class="icon-link pr-5"></i>View Details</a>
															</span>
														</div>
													</div>
													<div class="body">
