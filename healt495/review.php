...
if ($coupon_discount == 0) {
	$string = "(Shipping fee included)";
}else {
	$string = "(Shipping fee and coupon discount included)";
}
$bname = "$bfname $blname";
$sname = "$sfname $slname";
					...
					<div class="row">
						...
						<div class="main col-md-12">
							...
							<div class="share_button pull-right row" style="margin-top:-38px;">	
											...
											<div class="share_button">
												...
												?>
													...
													<form name="paypal_form" action="https://www.sandbox.paypal.com/cgi-bin/webscr" >
														...
														<div class="share_button"><button id="paypal_button" class="btn btn-group btn-info pull-right" style="margin-top:-25px;" >Pay via PayPal</button>
														</div>	
										...
										<a href="mycart.php" class="btn btn-group btn-default pull-right" style="margin-top:5px;">Go Back to My Cart</a>
