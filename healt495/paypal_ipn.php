...
if($_POST)
{
        ...
        if (strcmp ($res, "VERIFIED") == 0)
        {
			...
			$activation_fee = $gift_total - ($_POST['mc_gross']/1.029 + 0.4);
				...
				$customer_sql = mysqli_fetch_assoc(mysqli_query($db, "SELECT * FROM customer WHERE email='$account_email'"));
				$zh = $customer_sql['zh'];
				$first_name = $customer_sql['first_name'];
				$last_name = $customer_sql['last_name'];
																					...
																					<table align="left" border="0" cellpadding="0" cellspacing="0" width="100%" style="border-collapse: collapse;">
																						...
																						<tr>
																							<td width="100%" align="left" style="font-size: 15px; line-height: 22px; font-family:helvetica, Arial, sans-serif; color:#777777;">
																								<p>Hi '.$bname.'!</p>
																								<p>A total of $'.number_format($total,2).'(USD) has been charged to your PayPal account and will be shipped to:<br/>'.$address.'</p>
																					...
																					<table align="left" border="0" cellpadding="0" cellspacing="0" width="100%" style="border-collapse: collapse;">
																						...
																						<tr>
																							<td width="100%" align="left" style="font-size: 15px; line-height: 22px; font-family:helvetica, Arial, sans-serif; color:#777777;">
																								...
																								<p>您的发票号是 '.$invoice.'. <br/>请的路您的<a href="https://healthsupplementsplus.com/zh/myaccount.php">帐户</a>去查看您的订单</p>
																								<p>请稍候2至3个工作日发货。</p>
			...
			$mail->Subject = "Thank you for your order!/您的订单已完成! (Completed)";
			$mail->Body = $message;
