				...
				<div class="container">
					<div class="row">
						...
						<div class="main col-md-12">
							...
							<div class="row">
							<div class="col-md-10">
							<h1 id="shopping_num" class="page-title">购物车: <?echo $cart_exist;?> 件</h1>
							</div>
							</div>					
							...
							<div id="cart_msg">
								<?
									if ($cart_exist == 0) {?>
										您的购物车里是空的！<br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/>
									<?}else {?>
							</div>		
										<table class="table cart table-hover table-colored">
											...
											?>
														...
														<tr class="remove-data">
															...
															<td class="remove">
															<input type="submit" id="id_<?echo $cart_product_id;?>_<?echo $user_email;?>_<?echo $sub_total?>" value="删除" class="btn btn-remove btn-sm btn-default del_button">
											...
											?>
												...
												-->
													<tr>										
														<td class="total-quantity" colspan="2">折扣券:</td>
														<td class="coupon" colspan="2">
															<input type="text" id="coupon" placeholder="折扣券码" class="form-control">
															<div id="output" style="color:green;"></div>
															
														</td>
														<td class="amount" id="coupon_amount">--</td>
													</tr>
													<td class="total-quantity" colspan="4">总价:</td>
							...
							<?
								...
								<div id="checkout_remove">
									...
									<div class="text-right">									
										<input type="submit" class="btn btn-group btn-default" value="结账">
									</div>
