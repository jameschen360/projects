								...
								<tbody>
											<?
												while ($cart_result = mysqli_fetch_assoc($cart_check)) {
													...
													while ($product_result = mysqli_fetch_assoc($product_check)) {
														...
														$product_name = $product_result['zh_name'];
														$product_detail = $product_result['zh_detail'];
											...
											?>								
														...
														<tr class="remove-data">
															...
															<?	}else { ?>
																	<a data-toggle="price" data-placement="bottom" title="优惠价已包括"><?echo $symbol?><?echo number_format($product_price,2);?>*</a>
															<?	}																
															?>
...
**/												
									...
									<?
										...
										if ($discount_number!="--"){?>
											<tr>										
												<td class="total-quantity" colspan="3">您省了:(<?echo $discount_percentage_num?>%)</td>
									...
									<?
										...
										if ($discount_number!="--"){?>
											<tr>
												<td class="total-quantity" colspan="3">打折后:</td>
									...
									<!-- SHIPPING -->
									<tr>										
										<td class="total-quantity" colspan="1">邮递方式:</td>
										...
										<input type="hidden" id="checkout_final" value="<?echo $total_price_post+$shipping_price?>">
											<select class="form-control" id="shipping_option">
												<option value="standard">普通邮递</option>
												<option value="express">快速邮递</option>
											</select>
								...
								<form role="form" class="form-horizontal" id="billing-information">
									<div class="row">
										...
										<div class="col-lg-8 col-lg-offset-1">
											<div class="form-group">
												<label for="billingFirstName" class="col-md-2 control-label">名字<small class="text-default">*</small></label>
												<div class="col-md-10">
													<input type="text" class="form-control" id="billingFirstName" value="<?echo $personal_fname;?>">
												</div>
											</div>
											<div class="form-group">
												<label for="billingLastName" class="col-md-2 control-label">姓<small class="text-default">*</small></label>
												<div class="col-md-10">
													<input type="text" class="form-control" id="billingLastName" value="<?echo $personal_lname;?>">
												</div>
											</div>
											<div class="form-group">
												<label for="billingTel" class="col-md-2 control-label">电话<small class="text-default">*</small></label>
												<div class="col-md-10">
													<input type="text" class="form-control" id="billingTel" value="">
												</div>
											</div>
											<div class="form-group">
												<label for="billingFax" class="col-md-2 control-label">传真</label>
												<div class="col-md-10">
													<input type="text" class="form-control" id="billingFax" value="">
												</div>
											</div>
											<div class="form-group">
												<label for="billingemail" class="col-md-2 control-label">电子信箱<small class="text-default">*</small></label>
												<div class="col-md-10">
									...
									<div class="row">
										...
										<div class="col-lg-8 col-lg-offset-1">
											<div class="form-group">
												<label for="billingAddress1" class="col-md-2 control-label">地址一<small class="text-default">*</small></label>
												<div class="col-md-10">
													<input type="text" class="form-control" id="billingAddress1" value="<?echo $personal_address;?>">
												</div>
											</div>
											<div class="form-group">
												<label for="billingAddress2" class="col-md-2 control-label">地址二</label>
												<div class="col-md-10">
													<input type="text" class="form-control" id="billingAddress2" value="">
												</div>
											</div>
											<div class="form-group">
												<label class="col-md-2 control-label">国家<small class="text-default">*</small></label>
												<div class="col-md-10">
													<input type="text" class="form-control" id="country_bill" value="<?echo $country;?>">
												</div>
											</div>
											<div class="form-group">
												<label for="billingCity" class="col-md-2 control-label">城市<small class="text-default">*</small></label>
												<div class="col-md-10">
													<input type="text" class="form-control" id="billingCity" value="<?echo $personal_city;?>">
												</div>
											</div>
											<div class="form-group">
												<label for="billingProvince" class="col-md-2 control-label">州/省<small class="text-default">*</small></label>
												<div class="col-md-10">
													<input type="text" class="form-control" id="billingProvince" value="<?echo $personal_province;?>">
												</div>
											</div>											
											<div class="form-group">
												<label for="billingPostalCode" class="col-md-2 control-label">邮政编码<small class="text-default">*</small></label>
												<div class="col-md-10">
								...
								<form role="form" class="form-horizontal" id="shipping-information-container">
									<div id="shipping-information" class="space-bottom">
										<div class="row">
											...
											<div class="col-lg-8 col-lg-offset-1">
												<div class="form-group">
													<label for="shippingFirstName" class="col-md-2 control-label">名字<small class="text-default">*</small></label>
													<div class="col-md-10">
														<input type="text" class="form-control" id="shippingFirstName" value="<?echo $personal_fname;?>">
													</div>
												</div>
												<div class="form-group">
													<label for="shippingLastName" class="col-md-2 control-label">姓<small class="text-default">*</small></label>
													<div class="col-md-10">
														<input type="text" class="form-control" id="shippingLastName" value="<?echo $personal_lname;?>">
													</div>
												</div>
												<div class="form-group">
													<label for="shippingTel" class="col-md-2 control-label">电话<small class="text-default">*</small></label>
													<div class="col-md-10">
														<input type="text" class="form-control" id="shippingTel" value="">
													</div>
												</div>
												<div class="form-group">
													<label for="shippingFax" class="col-md-2 control-label">传真</label>
													<div class="col-md-10">
														<input type="text" class="form-control" id="shippingFax" value="">
													</div>
												</div>
												<div class="form-group">
													<label for="shippingemail" class="col-md-2 control-label">电子信箱<small class="text-default">*</small></label>
													<div class="col-md-10">
										...
										<div class="row">
											...
											<div class="col-lg-8 col-lg-offset-1">
												<div class="form-group">
													<label for="shippingAddress1" class="col-md-2 control-label">地址一<small class="text-default">*</small></label>
													<div class="col-md-10">
														<input type="text" class="form-control" id="shippingAddress1" value="<?echo $personal_address;?>">
													</div>
												</div>
												<div class="form-group">
													<label for="shippingAddress2" class="col-md-2 control-label">地址二</label>
													<div class="col-md-10">
												...
												<div class="form-group">
													<label for="shippingCity" class="col-md-2 control-label">城市<small class="text-default">*</small></label>
													<div class="col-md-10">
														<input type="text" class="form-control" id="shippingCity" value="<?echo $personal_city;?>">
													</div>
												</div>
												<div class="form-group">
													<label for="shippingProvince" class="col-md-2 control-label">州/省<small class="text-default">*</small></label>
													<div class="col-md-10">
														<input type="text" class="form-control" id="shippingProvince" value="<?echo $personal_province;?>">
													</div>
												</div>												
												<div class="form-group">
													<label for="shippingPostalCode" class="col-md-2 control-label">邮政编码<small class="text-default">*</small></label>
													<div class="col-md-10">
									...
									<div class="checkbox padding-top-clear">
										<label>
											<input type="checkbox" id="shipping-info-check" checked> 我的邮递资料和我账单资料的地址和联系方式是统一的。
										</label>
									</div>
								</form>
							</fieldset>
							...
							<div id="review_form_error"></div>
								<a href="mycart.php" class="btn btn-group btn-default"><i class="icon-left-open-big"></i> 购物车</a>
								<input type="submit" id="review_order" class="btn btn-group btn-default" value="结帐">
							</div>
