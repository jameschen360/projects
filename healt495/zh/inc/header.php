								...
								<div id="header-top-second"  class="clearfix">
									...
									<div class="header-top-dropdown text-right" style="padding-top:4px;">
										...
										<select class="btn dropdown-toggle btn-default btn-sm currency_change">
											<option disabled>货币:</option>
											<?
												if($currency_factor == "usd" or $currency_factor =="USD") { ?>
													<option value="usd" id="usd" selected>美元</option>
													<option value="rmb" id="rmb">人民币</option>
											<?	} else {?>
													<option value="usd" id="usd" >美元</option>
													<option value="rmb" id="rmb" selected>人民币</option>												
											<?}
											?>
										...
										<div class="container-fluid">
											...
											<div class="navbar-header">
												...
												<div class="header-left clearfix">
													...
													<div id="logo" class="logo">
														<a href="index.php"><img id="logo_img" src="images/logo_purple.png" height="35px" width="150px" alt="The Project"></a>
													</div>
											...
											<div class="collapse navbar-collapse" id="navbar-collapse-1">
												...
												<ul class="nav navbar-nav navbar-right">
													...
													<li class="dropdown ">
														<a class="dropdown-toggle" data-toggle="dropdown" href="#">产品</a>
														<ul class="dropdown-menu">
														<?
															while ($i < $row_count_catagory) {
																if ($sub[$i] == "0") {?>
																	<li ><a href="product.php?catagory=<?echo strtolower($link_name[$i]);?>&id=<?echo $id[$i]?>"><?echo $name[$i]?></a></li>
																<?	$i++;
																} else {?>
																	<li class="dropdown ">
																		...
																		<ul class="dropdown-menu">
																			<?
																			for ($j = 0; $j < $sub[$i] ; $j++) {?>
																				<?$sub_catagory = explode(",",$link_subname[$i]);?>
																				<?$sub_catagory_zh = explode(",",$subname[$i]);?>
																				<li ><a href="product.php?catagory=<?echo strtolower($sub_catagory[$j])?>&id=<?echo $id[$i]?>"><?echo $sub_catagory_zh[$j]?></a></li>
																			<?}
																			?>
																		</ul>
																	</li>
													...
													{?>
													<li>
														<a id="change_num" href="mycart.php">购物车 (<?echo $cart_row?>)</a>
													</li>												
													<li class="dropdown"">
														<a class="dropdown-toggle" data-toggle="dropdown" href="#">您好，<?echo $user_fname;?><i class="fa fa-gear pr-10" style="padding-left:3px;"></i></a>
														<ul class="dropdown-menu ">
															<li>
													...
													<li class="dropdown"">
														<a class="dropdown-toggle" data-toggle="dropdown" href="#">登录<i class="fa fa-lock pr-10" style="padding-left:3px;"></i></a>
														<ul class="dropdown-menu " style="padding:14px;">
														<form action="" class="login-form margin-clear contact" method="POST">
															<div class="form-group has-feedback">
																<label class="control-label">电子邮箱</label>
																<input type="text" class="form-control" id="username" name="username" autocomplete="off" placeholder="myemail@163.com" required="required">
																<i class="fa fa-user form-control-feedback"></i>
															</div>
															<div class="form-group has-feedback">
																<label class="control-label">密码</label>
																<input type="password" class="form-control" id="password" name="password" autocomplete="off" placeholder="*****" required="required">
																<i class="fa fa-lock form-control-feedback"></i>
															</div>
															
															<input id="login" type="submit" class="btn btn-danger btn-sm" value="登录">
															<span class='msg'></span>
															<div id="error"></div>	
															<a href="passwordreset.php">忘记密码？</a>
														</form>														
														</ul>
													</li>
													<?}?>
														...
														<ul class="dropdown-menu dropdown-menu-right dropdown-animation">
															<li>
																<form role="search" class="search-box margin-clear" action="search.php" method="GET">
																	<div class="form-group has-feedback">
																		<input type="text" name="keyword" class="form-control" placeholder="搜索"  autocomplete="off" required>
