				...
				<div class="container">
					<div class="row">
						...
						<div class="main col-md-8 col-md-offset-2">
							...
							<h1 class="page-title text-center">付款完成，谢谢 <i class="fa fa-smile-o pl-10"></i></h1>
							<div class="separator"></div>
							<!-- page-title end -->
							<p class="lead text-center">订单详细情况在你的<a href="myaccount.php">“我的账户”</a> 里</p>
							...
							<p class="text-center">
								<a href="order.php?order_id=<?echo $invoice?>" class="btn btn-default btn-lg">查看订单号 <?echo $invoice?></a>	
							</p>	
																...
																<tr>
																	<td align="left">
																		<a href="https://healthsupplementsplus.com">
																			<img src="https://healthsupplementsplus.com/services/images/logo_purple.png" alt="HSP" height="35px" width="150px" style="display: block;"/>
																		</a>
																	</td>
																</tr>
																<!-- company slogan -->
																					...
																					<table align="left" border="0" cellpadding="0" cellspacing="0" width="100%" style="border-collapse: collapse;">
																						...
																						<tr>
																							<td width="100%" align="left" style="font-size: 15px; line-height: 22px; font-family:helvetica, Arial, sans-serif; color:#777777;">
																								<p>您好 '.$bname.'!</p>
																								<p>'.$symbol.''.number_format($total,2).' '.$trail.' 已扣除您的账户 <br/>邮递到:<br/>'.$address.'</p>
																								<p>您的发票号是: '.$invoice.'. <br/>请的路您的<a href="https://healthsupplementsplus.com/myaccount.php">帐户</a>去查看您的订单</p>
																								<p>请稍候2至3个工作日发货。</p>
