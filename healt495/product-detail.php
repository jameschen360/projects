...
if ($product_detail_check == 0) {
	...
	$product_detail_array = mysqli_fetch_assoc($product_detail);
		...
		$product_detail_name = $product_detail_array['name'];
		$product_detail_desc = $product_detail_array['detail'];
		...
		$product_detail_pdf = $product_detail_array['pdf'];
			...
			<div class="breadcrumb-container">
				<div class="container">
					<ol class="breadcrumb">
						...
						<li><a href="product.php?catagory=<?echo $catagory_name;?>"><?echo strtoupper($catagory_name);?></a></li>
						...
						<div class="main col-md-12">
							...
							<div class="row">
								...
								<div class="col-md-8 pv-30">
									...
									<button class="btn btn-info" data-toggle="modal" data-target="#pdf_listing">View PDF description</button>								
									...
									<div class="clearfix mb-20">
										...
										?>
																...
																<?	} else {?>
																		<strong><span style="color:#ab6cc6;">In Stock: <?echo $product_detail_stock?></span></strong>
																<?	}
																?>										
									...
									<div class="light-gray-bg p-20 bordered clearfix">
										...
										<?
											if($product_detail_discount != 0 or !empty($product_detail_discount)) {?>
												<strong><span style="color:#FE2E2E;"><?echo $product_detail_discount*100?>% OFF</span><strong><br/>												
										<?	}
										?>										
										...
										<div id="cart_msg"></div>
															<?
																if (!empty($_SESSION['login_user'])) {
																	if ($stock_status == 1) {?>
															      <input type="submit" id="addcart" value="Add to Cart" class="margin-clear btn btn-default pull-right">																		
															<?		}else {?>
															      <input type="submit" value="Add to Cart" class="margin-clear btn btn-default pull-right"disabled>																	
															<?		}
																}else {?>
																	<center>Please <a data-toggle="modal" data-target="#myModal">login/sign up</a> to add to cart</center>
															<?	}
															?>
				...
				<div class="container">
					<div class="row">
						<div class="col-md-8">
							...
							<ul class="nav nav-tabs style-4" role="tablist">
								<li class="active"><a href="#comment" role="tab" data-toggle="tab"><i class="fa fa-check pr-5"></i>Reviews (<?echo $comment_check_row;?>)</a></li>
							</ul>
							<!-- Tab panes -->
								...
								<div class="tab-pane fade in active" id="comment">
									...
									<?
										if ($comment_check_row == 0) {
											echo "There are currently no reviews. Be the first!<br/><br/>";
										} else {
									...
									<div class="comments-form">
										<h2 class="title" id="comment_change">You have already submitted a review</h2>		
									</div>												
									<?	}else {?>
									<!-- comments form start -->
									<div class="comments-form">
										<h2 class="title" id="comment_change">Submit a review!</h2>
										<div id="comment_msg"></div>
										<form role="form" class="comment_post" id="comment-form">
											<div class="form-group has-feedback">
												<label for="subject4">Title</label>
										...
										<input type="submit" id="comment_submit" value="Submit" class="btn btn-default">
									</div>
									<!-- comments form end -->										
									<?}
									?>
								...
								<div class="block clearfix">
									...
									<?
										...
										while($related_result = mysqli_fetch_assoc($related_product)) {
											$related_name = $related_result['name'];
											...
											<p class="margin-clear">
												...
												<?
													if ($related_stock == "" or $related_stock == 0) {?>
														<strong><span style="color:#FE2E2E;">Out of Stock</span></strong>
												<?	}else {?>
														<strong><span style="color:#ab6cc6;">In Stock: <?echo $related_stock?></span></strong>
												<?}
												?>
					...
					<div class="modal fade modal_login_style" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
					  <div class="modal-content modal-dialog modal-sm">
						  <div class="modal-header">
							  ...
							  <h4 class="modal-title" id="modalla">Login to Health Supplements Plus</h4>
						  </div>
									  ...
									  <div class="well">
										  <form id="loginForm" novalidate="novalidate">
											  <div class="form-group">
												  ...
												  <input type="text" class="form-control" id="username_modal" name="username" value="" required="" title="Please enter your username" placeholder="example@gmail.com">
												  <span class="help-block"></span>
											  </div>
											  <div class="form-group">
												  <label for="password" class="control-label">Password</label>
												  <input type="password" class="form-control" id="password_modal" name="password" value="" required="" title="Please enter your password">
												  <span class="help-block"></span>
											  </div>								  
										  </form>
										  <div id="error_modal"></div>
										  <input id="login_modal" type="submit" class="btn btn-danger btn-block" value="Login">
										  <a href="passwordreset.php">Forgot password</a><br/>
					...
					<div class="modal fade modal_login_style" id="pdf_listing" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
					  <div class="modal-content modal-dialog modal-lg">
						  <div class="modal-header">
							  <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">×</span><span class="sr-only">Close</span></button>
							  <h4 class="modal-title" id="modalla"><?echo $product_detail_name?> Product Description</h4>
						  </div>
