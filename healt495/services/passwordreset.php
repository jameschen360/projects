...
if ($email!="" && $row == 1) {
																					...
																					<table align="left" border="0" cellpadding="0" cellspacing="0" width="100%" style="border-collapse: collapse;">
																						...
																						<tr>
																							<td width="100%" align="left" style="font-size: 15px; line-height: 22px; font-family:helvetica, Arial, sans-serif; color:#777777;">
																								<p>Hi '.$fname.' '.$lname.'!</p>
																								<p>It appears that you have tried to reset your password.</p>
																								<p>Your new password is <b>'.$rand.'</b></p>
																								<p>You can always login and change your password again.</p>
																								<br/>
			...
			$mail->Subject = "New Password Reset";
			$mail->Body = $message;
			...
			echo "<center><p style=\"font-size:25px;\"><font color=\"green\"><strong>A new password has been sent to your registered email!</strong></font></p></center>";
		} else {
			echo "<center><p style=\"color:red;\" >The email you have entered does not exist!</p></center>";
	}
}
